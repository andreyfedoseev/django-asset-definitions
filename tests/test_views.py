...
def test_media_from_definition():
    class View(MediaDefinitionView, asset_definitions.MediaDefiningView):
        pass
...
def test_form_media():
    class View(FormView, asset_definitions.MediaDefiningView):
        pass
...
def test_combined():
    class View(MediaDefinitionView, FormView, asset_definitions.MediaDefiningView):
        pass
